...
export default function Content(props) {
    return (
        ...
        <div className="lg:h-[130px] lg:w-[230px] bg-white shadow-lg rounded-xl items-center justify-center text-center xs:inline-grid p-3 mx-auto md:mt-11 sm:mt-5 xs:mb-5 xs:-mt-2 relative group hover:bg-[#00A859] 
