...
export default function Content(props) {
    return (
        ...
        <div className="lg:h-[150px] lg:w-[250px] bg-white shadow-2xl rounded-xl items-center justify-center text-center xs:inline-grid p-3 mx-auto md:mt-11 sm:mt-5 xs:mb-5 xs:-mt-2 relative group hover:bg-[#00A859]
            ...
            ss:translate-x-5 xs:translate-x-0
            ' />
            <div className="mx-auto ">
                <p className='lg:text-[15px] lg:top-24 md:text-[12px] md:top-14 sm:text-[11px] xs:text-[10px] text-[#00A859] font-sans font-medium mt-2 absolute inset-x-0 bottom-3 group-hover:text-white ss:top-7 ss:left-40 ss:text-left xs:top-24 xs:text-center xs:-left-0'>
                    {props.content.title}
                </p>
            </div>
        </div>
