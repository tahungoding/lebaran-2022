...
export default function Kedaruratan_Lainnya( props) {
          ...
          <div className="min-h-screen px-4 text-center">
            ...
            >
              <div className="inline-block w-full max-w-md p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl">
                ...
                <Dialog.Title
                  as="h3"
                  className="text-lg text-center font-medium leading-6 flex justify-center items-center text-gray-900 my-4"
                >
                  {props.content.title}
                </Dialog.Title>
