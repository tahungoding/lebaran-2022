        ...
        <div className='bg-[#00A859] sm:h-[168px] w-full xs:h-[100px] sm:mt-12 ss:mt-5 items-center justify-center text-center inline-flex'>
            ...
            <div className='inline-grid text-center'>
                ...
                <a className="flex mx-auto mt-4 mb-2 space-x-3 text-center">
                    <img src="/assets/img/instagram.png" alt="" className='md:w-6 sm:w-5 sm:h-5 xs:h-4 ss:h-4' />
                ...
                <a className="flex mx-auto space-x-3 text-center">
                    <img src="/assets/img/github.png" alt="" className='md:w-6 sm:w-5 sm:h-5 xs:h-4 ss:h-4' />
                    <p className='font-sans font-medium text-white md:text-base sm:text-sm xs:text-[11px] ss:text-[11px]'>tahungoding</p>
