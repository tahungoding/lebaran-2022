...
export default function Sarana() {
    return (
        <div className='md:mt-16 sm:mt-10 ss:mt-5 lg:mx-auto md:container' id='sarana'>



            <div className="container justify-center text-center lg:text-3xl md:text-2xl  ss:text-md ss:-mt-4 font-sans font-medium
                text-[#3F3D56]">
            ...
            <div className="xs:flex justify-center 2xl:gap-32 xl:gap-16 lg:gap-5 md:gap-4 sm:gap-8 xs:gap-3 ss:inline-block ss:mx-auto ss:container ss:gap-y-8">
                <div className="">
